...
st.set_page_config(page_title='ML Model Performance Monitoring',
    layout='wide')

#---------------------------------#
st.write("""# ML MODEL PERFORMANCE MONITORING""")
...
parameter_n_estimators = st.sidebar.slider('Number of estimators (n_estimators)', 0, 500, (10,50), 10)
